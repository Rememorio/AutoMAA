...
`AutoMAA-logo.png`、`AutoMAA-icon.png`、由其生成的 `AutoMAA.icns`、`AutoMAA-slogan.png` 及其网页衍生资源不属于仓库根目录 MIT License 的授权范围。
...
宣传字图是 AutoMAA 独立制作的非官方项目视觉，不包含官方 Logo、角色形象或原始活动素材；它仅用于表达“直到日常变成一次运行”的产品主张，不代表任何官方合作或背书。

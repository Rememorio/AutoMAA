...
<section class="product-showcase" aria-labelledby="product-tour-title">
  ...
  <div class="product-shot-grid">
    <figure class="product-shot">
      <img class="theme-shot theme-shot-light" src="./assets/screenshots/client-settings-light.webp" width="2320" height="1520" loading="lazy" decoding="async" alt="AutoMAA 客户端配置：服务器、应用、MaaTools、独立 Profile、账号队列和生命周期保护" />
      <img class="theme-shot theme-shot-dark" src="./assets/screenshots/client-settings-dark.webp" width="2320" height="1520" loading="lazy" decoding="async" alt="AutoMAA 客户端配置：服务器、应用、MaaTools、独立 Profile、账号队列和生命周期保护" />
